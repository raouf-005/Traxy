...
export default function Annonce() {
  return (
    <div className="flex flex-col sm:gap-6 gap-4 text-center justify-center items-center text-white   py-20">
      <p className=" font-normal sm:text-[16px] text-sm  ">Suffering from Rising Energy Costs?</p>
      ...
      <Button className="bg-[#7959D4] text-white sm:text-md   font-semibold sm:px-12 sm:h-14 rounded-3xl">Contact Us</Button>
    </div>
  );
}
