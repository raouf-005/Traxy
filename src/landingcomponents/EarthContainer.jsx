...
export default function EarthContainer() {
  return (
    <div className="flex flex-row justify-center px-24 text-white   py-12">
      <EarthLayout />
      <div className="flex-1 flex justify-center items-top mt-40">
        <p className="text-center  leading-[47px] max-w-2xl text-lg ">
