...
export default function Navbar() {
  ...
  return (
    <nav className="flex flex-row  px-12  py-4 bg-black text-white justify-between">
      ...
      <div className="flex flex-row gap-12   items-center">
        ...
        }} className="bg-transparent text-white">Energy Solaire</Button>
        <Button   onClick={()=>{
          navigate('/gps')
        }} className="bg-transparent text-white">GPS tracking System</Button>
        <Button onClick={handleClick()}  className="bg-transparent text-white">Produits</Button>
      </div>
