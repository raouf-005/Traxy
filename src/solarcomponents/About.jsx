  ...
  return (
    <div className=" flex flex-col  p-6 py-12 md:gap-16 gap-12">
      <div className="">
        ...
        <h2 className=" md:text-4xl text-2xl  font-bold text-white">Why Choose Us?</h2>
      </div>
      <div className="flex flex-row justify-center gap-10  ">
        <div className=" flex flex-row items-center justify-center  shadow-xl p-8  gap-10 bg-white rounded-3xl">
          ...
          <div className="flex flex-col sm:gap-12 gap-5  max-w-md items-start">
            <p className=" sm:text-lg font-semibold text-[#7959D4]">Solar energy</p>
            <h2 className=" text-xl sm:text-3xl text-balance font-bold">Expert Installation</h2>
            ...
            <Button className=" bg-[#7959D4] rounded-2xl  max-w-md sm:text-md sm:h-14 sm:px-12  text-white">
              Read More
            </Button>
          </div>
        </div>
