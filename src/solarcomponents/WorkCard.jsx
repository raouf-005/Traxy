...
export default function WorkCard(props) {
  return (
    <div className={`${props.color?'bg-[#7959D4]':'bg-white '} text-slate-200  flex flex-col justify-center items-center pt-[3%] md:pt-6 pb-[7%] px-[1.5%] sm:px-[0%]  rounded-[1.5rem] gap-6`}>
