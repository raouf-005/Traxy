...
export default function OurServices(props) {
  return (
    <div className="md:px-16 px-9 py-20 ">
    <div className="flex flex-col justify-center items-center gap-8 md:gap-20 p-10 md:py-32 py-8 bg-[#B28EFF] text-white rounded-[4rem]">
      <h1 className=" lg:text-9xl md:text-6xl text-4xl  font-bold">Our Services</h1>
      <div className="flex flex-row  justify-center  md:gap-[6%] items-center">
        <Image
          src={Dash}
          alt="progress"
